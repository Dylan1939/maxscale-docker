...
## Prerequisites:
 Docker.io Installed, Docker Compose, Mariadb installed
...
```
git clone https://github.com/Dylan1939/maxscale-docker
```
### Access the directroy 
```
cd maxscale-docker/maxscale/
```
### Bring up the containers within the directory
```
sudo docker-compose up -d
```
#### The terminal will now show three containers. (Master 1, Master 2, Maxscale) 
```
...
```
#### The table should look like this after entering the command 
```
┌────────────────┬─────────┬──────┬─────────────┬─────────────────┬───────────┐
...
```
#### Should like simliar to the code below  
```
...
MariaDB [(none)]> 
```
### Enter this command to see the files withing your database 
```
show databases;
```
```
...
```
### Enter this command to see the last Ten zipcodes in zipcodes_one
```
...
### This command shows the first ten from zipcodes_two 
```
...
### Use this command to see the largest zipcode in zipcodes_one
```
...
+---------+
```
### Use this command to see the smalled zipcode in zipcodes_two
```
